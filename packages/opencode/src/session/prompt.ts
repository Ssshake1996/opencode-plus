...
import { ContextAssembler } from "./context-compressor"
...
export namespace SessionPrompt {
  ...
  export const loop = fn(LoopInput, async (input) => {
    ...
    // Auto-trigger context compression if turns exceed threshold
    ...
    if (cfg.compaction?.auto) {
      ...
      const { shouldArchive, archived } = ContextAssembler.autoArchiveIfNeeded(
        messages,
        archivedTopics,
        cfg.compaction,
      )
